<template>
  ...
  >
    <div class="mx-auto max-w-[490px]">
      <img src="@/assets/images/illustration/illustration-02.svg" alt="illustration" />
      ...
      <div class="mt-7.5 text-center">
        ...
        <p class="font-medium">
          Thank you so much for your message. We check e-mail frequently and will try our best to
