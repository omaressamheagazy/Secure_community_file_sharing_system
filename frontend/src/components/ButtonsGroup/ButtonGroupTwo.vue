        ...
        >
          <template v-for="(item, index) in groupItem.children" :key="index">
            <router-link
              ...
              :to="item.link"
              class="inline-flex items-center gap-2.5 py-1 px-2 font-medium hover:border-primary hover:bg-primary hover:text-white dark:hover:border-primary sm:py-3 sm:px-6"
              :class="{
