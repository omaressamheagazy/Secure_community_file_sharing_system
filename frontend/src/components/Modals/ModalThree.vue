...
<template>
  <div>
    <button
      ...
      class="rounded-md bg-primary py-3 px-9 font-medium text-white hover:bg-opacity-90"
    >
      Modal 3
    </button>
    ...
    >
      ...
      >
        ...
        <h3 class="mt-5.5 pb-2 text-xl font-bold text-white sm:text-4xl">Congratulations!</h3>
