...
const handleChange = () => {
  ...
  emit('getSelectedValue', selectedOption.value)
}
</script>
  ...
  <div>
    ...
    <div class="relative z-20 bg-white dark:bg-form-input">
      ...
      >
        ...
        <option :value="STATUS.accept" class="text-body dark:text-bodydark">Accept</option>
        <option :value="STATUS.reject" class="text-body dark:text-bodydark">Reject</option>
      </select>
