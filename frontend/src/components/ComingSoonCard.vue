    ...
    <div class="flex h-screen flex-col items-center justify-center overflow-hidden">
      <div class="no-scrollbar overflow-y-auto py-20">
        <div class="mx-auto w-full max-w-[600px]">
          <div class="text-center">
            <router-link to="/" class="mx-auto mb-10 inline-flex">
              <img src="@/assets/images/logo/logo-dark.png" alt="logo" class="dark:hidden" />
              <img src="@/assets/images/logo/logo.png" alt="logo" class="hidden dark:block" />
            </router-link>
        ...
        <div class="mt-10 text-center">
          <p class="mb-5 font-medium text-black dark:text-white">Follow Us On</p>
