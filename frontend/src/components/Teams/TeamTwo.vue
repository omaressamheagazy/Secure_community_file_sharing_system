...
import teamOne from '@/assets/images/team/team-05.png'
import teamTwo from '@/assets/images/team/team-06.png'
import teamThree from '@/assets/images/team/team-07.png'
import teamFour from '@/assets/images/team/team-08.png'
...
<template>
  <div class="p-4 sm:p-6 xl:p-9 2xl:p-15">
    <div class="mx-auto w-full max-w-[1170px]">
      <div class="grid grid-cols-1 gap-7.5 sm:grid-cols-2 xl:grid-cols-4">
        <template v-for="(item, index) in teamItems" :key="index">
          <!-- team item -->
          <div
            class="group rounded-[10px] border border-stroke px-4 pb-10 pt-12 dark:border-strokedark"
          >
            <div class="relative z-1 mx-auto h-30 w-full max-w-30 rounded-full">
              <img class="rounded-full" :src="item.image" alt="team" />

              <span
                class="absolute right-0 top-0 -z-1 opacity-0 transition-all group-hover:opacity-100"
              >
                <svg
                  width="55"
                  height="53"
              ...
              <span
                class="absolute bottom-0 left-0 -z-1 h-9.5 w-9.5 rounded-full bg-meta-3 opacity-0 transition-all group-hover:opacity-100"
              ></span>
            </div>
