...
<template>
  <div class="mb-8 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
    <div>
      <h2 class="text-title-sm2 font-bold text-black dark:text-white">This Week’s Overview</h2>
    </div>
    ...
    <div class="flex items-center">
      ...
      <div class="relative z-20 inline-block">
        ...
        >
          <option value="" class="dark:bg-boxdark">Current Week</option>
        ...
        <div class="flex items-end justify-between">
          <div>
            ...
            <span class="mt-2 flex items-center gap-2">
              <span
                class="flex items-center gap-1 rounded-md p-1 text-xs font-medium text-white"
                :class="{ 'bg-meta-3': item.progress > 0, 'bg-red': item.progress < 0 }"
              >
                <svg
