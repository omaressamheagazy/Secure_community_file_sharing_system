  ...
  <div >
    <div class="relative inline-block">
      <a
        ...
        class="inline-flex items-center gap-2.5 rounded-md bg-black py-3 px-5.5 font-medium text-white hover:bg-opacity-95"
      >
        Dropdown Button
        <svg
      ...
      >
        <ul class="flex flex-col">
          <li>
            <a href="#" class="flex py-2 px-5 font-medium text-bodydark2 hover:text-white">
              Dashboard
            </a>
          </li>
          <li>
