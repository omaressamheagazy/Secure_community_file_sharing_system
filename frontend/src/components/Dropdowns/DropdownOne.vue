...
import { ref } from 'vue'
import UploadFileModel from '@/components/File/UploadFileModel.vue'
import CreateSubCommunityModal from '@/components/Community/CreateSubCommunityModal.vue'
  ...
  <div class="" ref="target">
    <div class="relative inline-block">
      <a href="#" @click.prevent="openDropDown = !openDropDown"
        class="inline-flex items-center gap-2.5 rounded-md bg-primary py-3 px-5.5 font-medium text-white hover:bg-opacity-95">
        {{ title }}
        <svg class="fill-current duration-200 ease-linear" :class="openDropDown && 'rotate-180'" width="12" height="7"
      ...
      <div v-show="openDropDown"
        ...
        <ul class="flex flex-col">
          ...
          <li>
            <slot name="element3"></slot>

          </li>
          <li>
            <slot name="element4"></slot>
          </li>
        </ul>
      </div>
    </div>
