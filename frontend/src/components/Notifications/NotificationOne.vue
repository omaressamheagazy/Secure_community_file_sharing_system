...
<template>
  <div class="p-4 sm:p-6 xl:p-10">
    <div class="max-w-[422px] rounded-lg py-4 pl-4 pr-4.5 shadow-2 dark:bg-meta-4">
      <div class="flex items-center justify-between">
        <div class="flex flex-grow items-center gap-5">
          ...
          <div>
            ...
            <p class="text-sm font-medium">your message sent successfully</p>
          </div>
        </div>

        <div>
          <button class="text-[#B1B1B1] hover:text-black dark:hover:text-white">
            <svg
              width="14"
              height="14"
              viewBox="0 0 14 14"
