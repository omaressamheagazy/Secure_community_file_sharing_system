      ...
      <div class="flex items-center justify-between">
        <div class="flex flex-grow items-center gap-5">
          ...
          <div>
            ...
            <p class="text-sm font-medium">Sorry! There was a problem with your request</p>
          </div>
        </div>

        <div>
          <button
            class="flex h-7 w-7 items-center justify-center rounded-md text-[#637381] bg-white dark:bg-meta-4 hover:text-black dark:hover:text-white"
          >
            <svg
              class="fill-current"
              width="14"
