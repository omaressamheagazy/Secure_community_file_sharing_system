  ...
  <div class="p-4 sm:p-6 xl:p-9">
    ...
    <div class="flex flex-wrap justify-between gap-5">
      <div>
        ...
        <a href="#" class="block"
          ><span class="font-medium text-black dark:text-white">Email:</span> contact@example.com</a
        >
        <span class="mt-1.5 block"
          ><span class="font-medium text-black dark:text-white">Address:</span> 2972 Westheimer Rd.
          Santa Ana.</span
        >
      </div>
      ...
      <div>
        ...
        >
        <span class="mt-1.5 block"
          ><span class="font-medium text-black dark:text-white">Address:</span> New York, USA 2707
          Davis Anenue</span
        >
      </div>
    </div>
    ...
    <div
      class="my-7.5 grid grid-cols-1 border border-stroke dark:border-strokedark xsm:grid-cols-2 sm:grid-cols-4"
    >
      <div
        ...
        <div class="min-w-[670px]">
          ...
          <template v-for="(item, index) in productList" :key="index">
            ...
            >
              ...
              <div class="col-span-2">
                <p class="font-medium">${{ item.pricePerUnit }}</p>
              </div>

              <div class="col-span-1">
                <p class="text-right font-medium">${{ item.total }}</p>
              </div>
            </div>
          </template>
        </div>
